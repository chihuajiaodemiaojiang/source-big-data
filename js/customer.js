...
let governmentList = document.querySelector('#governmentList')
let businessList = document.querySelector('#businessList')
let financeList = document.querySelector('#financeList')

dataList.forEach(function (v) {
    if (v.category === "finance") {
        financeList.innerHTML += `
     <li class="case-item fl">
              <a href="../page/customer-details.html" class="item-link"></a>
              <img class="pic" src="../images/${v.img}" alt="">
              <p class="item-name">
                ${v.name}
              </p>
              <p class="item-desc">
              ...
              <p class="btm-link">
                <span class="link-text">了解详情</span>
              </p>
...
let aside = document.querySelectorAll('.nav-item')
let floor = document.querySelectorAll('.floor')
aside.forEach(function (v, i) {
    v.onclick = function () {
        aside.forEach(function (v2) {
            v2.classList.remove('currentitem')
        })
        v.classList.add('currentitem')
        floor[i].scrollIntoView({behavior: "smooth"});
    }
});
